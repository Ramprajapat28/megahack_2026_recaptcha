    ...
    <div className="flex h-screen bg-white">
      ...
      <div className="flex-1 flex flex-col h-screen p-6 overflow-hidden">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-gray-800 tracking-tight">AI Tutor</h1>
        </div>

        {/* Embedded AI Tutor Page */}
        <div className="flex-1 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden relative">
          <iframe
            src="https://megahack-2026-recaptcha.onrender.com/tutor"
            title="AI Tutor"
