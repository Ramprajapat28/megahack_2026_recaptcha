...
const Adm_Sidebar = () => {
  ...
  // Check if any test routes are active
  const isTestRouteActive = [
    '/drafted-tests',
    '/scheduled-tests', 
    '/past-tests',
    '/live-tests'
  ...
  // Check if any analytics routes are active
  const isAnalyticsRouteActive = [
    '/admin/overall-score',
    '/admin/analytics',
  ...
  return (
    <div className="fixed left-0 top-0 w-64 h-full p-5 font-sans z-50">
      ...
      <ul className="list-none p-0 m-0">
        ...
        <li
          className={`flex items-center p-2 cursor-pointer transition-colors duration-300 hover:text-blue-500 group ${
            isTestRouteActive ? 'text-blue-500' : 'text-black'
          }`}
        ...
        >
          ...
          All Tests
          <span className={`ml-auto transition-transform duration-300 ${showSubmenu ? "rotate-180" : ""}`}>
            <svg
              width="10"
              height="6"
              viewBox="0 0 10 6"
        ...
        {showSubmenu && (
          <ul className="pl-5 mt-1">
            <li className="p-1 ml-4 cursor-pointer transition-colors duration-300 hover:text-blue-500">
              <NavLink to="/drafted-tests" className={({ isActive }) =>
                `${isActive ? "text-blue-500" : "text-black hover:text-blue-500"}`
              }>Drafted Tests</NavLink>
            </li>
            <li className="p-1 ml-4 cursor-pointer transition-colors duration-300 hover:text-blue-500">
              <NavLink to="/scheduled-tests" className={({ isActive }) =>
                `${isActive ? "text-blue-500" : "text-black hover:text-blue-500"}`
              }>Schedule Tests</NavLink>
            </li>
            <li className="p-1 ml-4 cursor-pointer transition-colors duration-300 hover:text-blue-500">
              <NavLink to="/past-tests" className={({ isActive }) =>
                `${isActive ? "text-blue-500" : "text-black hover:text-blue-500"}`
              }>Past Test</NavLink>
            </li>
            <li className="p-1 ml-4 cursor-pointer transition-colors duration-300 hover:text-blue-500">
              <NavLink to="/live-tests" className={({ isActive }) =>
                `${isActive ? "text-blue-500" : "text-black hover:text-blue-500"}`
              }>Live Test</NavLink>
            </li>
          </ul>
        ...
        <li
          className={`flex items-center p-2 cursor-pointer transition-colors duration-300 hover:text-blue-500 group ${
            isAnalyticsRouteActive ? 'text-blue-500' : 'text-black'
          }`}
        ...
        >
          ...
          Analytics
          <span className={`ml-auto transition-transform duration-300 ${showAnalyticsSubmenu ? "rotate-180" : ""}`}>
            <svg
              width="10"
              height="6"
              viewBox="0 0 10 6"
        ...
        {showAnalyticsSubmenu && (
          <ul className="pl-5 mt-1">
            <li className="p-1 ml-4 cursor-pointer transition-colors duration-300 hover:text-blue-500">
              <NavLink to="/admin/overall-score" className={({ isActive }) =>
                `${isActive ? "text-blue-500" : "text-black hover:text-blue-500"}`
              }>Overall Analytics</NavLink>
            </li>
            <li className="p-1 ml-4 cursor-pointer transition-colors duration-300 hover:text-blue-500">
              <NavLink to="/admin/analytics" className={({ isActive }) =>
                `${isActive ? "text-blue-500" : "text-black hover:text-blue-500"}`
              }>Branch Analytics</NavLink>
            </li>
            <li className="p-1 ml-4 cursor-pointer transition-colors duration-300 hover:text-blue-500">
              <NavLink to="/admin/student-analysis" className={({ isActive }) =>
                `${isActive ? "text-blue-500" : "text-black hover:text-blue-500"}`
              }>Student Analysis</NavLink>
            </li>
          </ul>
        )}
      </ul>
