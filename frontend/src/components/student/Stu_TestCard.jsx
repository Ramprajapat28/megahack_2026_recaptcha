      ...
      <div className="flex items-center mr-4">
        ...
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M14.4054 15.5586H7.78711C7.40761 15.5586 7.09961 15.2506 7.09961 14.8711C7.09961 14.4916 7.40761 14.1836 7.78711 14.1836H14.4054C14.7849 14.1836 15.0929 14.4916 15.0929 14.8711C15.0929 15.2506 14.7849 15.5586 14.4054 15.5586"
            fill="black"
          />
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M14.4054 11.7188H7.78711C7.40761 11.7188 7.09961 11.4108 7.09961 11.0313C7.09961 10.6518 7.40761 10.3438 7.78711 10.3438H14.4054C14.7849 10.3438 15.0929 10.6518 15.0929 11.0313C15.0929 11.4108 14.7849 11.7188 14.4054 11.7188"
            fill="black"
          />
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M10.3125 7.89063H7.78711C7.40761 7.89063 7.09961 7.58263 7.09961 7.20313C7.09961 6.82363 7.40761 6.51562 7.78711 6.51562H10.3125C10.692 6.51562 11 6.82363 11 7.20313C11 7.58263 10.692 7.89063 10.3125 7.89063"
            fill="black"
          />
          <mask id="mask0_1726_7343" maskUnits="userSpaceOnUse" x="2" y="1" width="18" height="20">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M2.75 1.83203H19.401V20.0827H2.75V1.83203Z"
              fill="white"
            />
          </mask>
          <g mask="url(#mask0_1726_7343)">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M14.5832 3.20703L7.535 3.2107C5.401 3.22353 4.125 4.54353 4.125 6.74261V15.1723C4.125 17.386 5.41292 18.7079 7.568 18.7079L14.6162 18.7051C16.7502 18.6923 18.0262 17.3704 18.0262 15.1723V6.74261C18.0262 4.52886 16.7392 3.20703 14.5832 3.20703ZM7.56892 20.0829C4.68692 20.0829 2.75 18.1093 2.75 15.1723V6.74261C2.75 3.77903 4.62642 1.85311 7.53042 1.8357L14.5823 1.83203H14.5833C17.4653 1.83203 19.4013 3.80561 19.4013 6.74261V15.1723C19.4013 18.1349 17.5248 20.0618 14.6208 20.0801L7.56892 20.0829Z"
              fill="black"
            />
          </g>
        </svg>
      ...
      <div className="flex items-center mr-4 mt-2 ">
        ...
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M11.0007 3.20703C6.70423 3.20703 3.20898 6.70228 3.20898 10.9987C3.20898 15.2951 6.70423 18.7904 11.0007 18.7904C15.2971 18.7904 18.7923 15.2951 18.7923 10.9987C18.7923 6.70228 15.2971 3.20703 11.0007 3.20703M11.0007 20.1654C5.94615 20.1654 1.83398 16.0532 1.83398 10.9987C1.83398 5.9442 5.94615 1.83203 11.0007 1.83203C16.0552 1.83203 20.1673 5.9442 20.1673 10.9987C20.1673 16.0532 16.0552 20.1654 11.0007 20.1654"
            fill="black"
          />
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M14.1453 14.3845C14.0252 14.3845 13.9042 14.3533 13.7933 14.2882L10.3375 12.2267C10.1303 12.102 10.002 11.8774 10.002 11.6354V7.19141C10.002 6.81191 10.31 6.50391 10.6895 6.50391C11.0699 6.50391 11.377 6.81191 11.377 7.19141V11.2449L14.4982 13.1057C14.8236 13.301 14.9309 13.7227 14.7365 14.049C14.6073 14.2644 14.379 14.3845 14.1453 14.3845"
            fill="black"
          />
        </svg>
